		...
		<div class="row">
		  <div class="col-md-12 mx-auto">
			<div class="card card-body mt-5 mb-5">
			  <h1 class="heading display-5 pb-3">Terms and Conditions</h1>
				...
				<ul>
					...
					<li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <?php echo $site_name; ?>.</li>
					<li><strong>Country</strong> refers to: New York, United States</li>
					<li><strong>Service</strong> refers to the Website.</li>
					<li><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
				  <li><strong>Website</strong> refers to <?php echo $site_name; ?>, accessible from <?php echo $site_name; ?></li>    
				...
				<ul>
					<li>By email: <?php echo $master_email; ?></li>
				</ul>
			</div>
		  </div>
		</div>
