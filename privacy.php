		...
		<div class="row">
		  <div class="col-md-12 mx-auto">
			<div class="card card-body mt-5 mb-5">
			  <h1 class="heading display-5 pb-3">Privacy policy</h1>
				...
				<ul>
					...
					<li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <?php echo $site_name; ?>.</p></li>
